...
public class I18nImportBeanDefinitionRegistrar implements ImportBeanDefinitionRegistrar, EnvironmentAware {
    ...
    private void registerI18nMessageSourceBeanDefinitions(
        ...
        BeanDefinition primaryBeanDefinition = rootBeanDefinition(DelegatingI18nMessageSource.class)
                .setPrimary(true)
                .getBeanDefinition();
    ...
    private Set<String> resolveSources(AnnotationAttributes attributes) {
        ...
        initSources(
                ...
                () -> environment.getProperty(
                        I18nConstants.SOURCES_PROPERTY_NAME, String[].class, ArrayUtils.EMPTY_STRING_ARRAY));
    ...
    private void registerMessageSourceAdapterBeanDefinition(
            AnnotationAttributes attributes, BeanDefinitionRegistry registry) {
    ...
    private boolean isEnabled() {
        ...
        logger.debug(
                "Rose i18n is {} , cased by the Spring property[name : '{}', default value : '{}']",
